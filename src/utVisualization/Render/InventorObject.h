...
#ifndef __InventorObject_h_INCLUDED__
#define __InventorObject_h_INCLUDED__
 ...
 * Component for Inventor render objects.
 * Provides a push-in port for poses and a push-in port for images.
 * This file was copied from X3DObject.h and modified to fit.
...
public:
	 ...
	 */
	InventorObject( const std::string& name, boost::shared_ptr< Graph::UTQLSubgraph > subgraph, 
